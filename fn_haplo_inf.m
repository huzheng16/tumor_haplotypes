function [ Hap_Mat_Z,Prop_Mat_W,p_o_est ] = fn_haplo_inf( variant_count,total_count,rep,alpha)

variant_count_rep = repmat(variant_count,rep,1);
total_count_rep = repmat(total_count,rep,1);


S = size(variant_count_rep,1);
T = size(variant_count_rep,2);
%%%%% initialization
...
for s = 1:S
    ...
    Data_s = variant_count_rep(s,:);
    N_st_s = total_count_rep(s,:);
